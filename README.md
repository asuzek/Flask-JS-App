...
Deploy your [Flask app to Heroku](https://bellybuttonbacterias.herokuapp.com/).
...
* Test your routes by visiting each one in the [browser](https://bellybuttonbacterias.herokuapp.com/).
